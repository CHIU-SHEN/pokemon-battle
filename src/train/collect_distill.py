...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out", type=Path, default=PROJECT_ROOT / "artifacts" / "dev_smoke" / "samples.jsonl")
    parser.add_argument("--schema-out", type=Path, default=PROJECT_ROOT / "artifacts" / "dev_smoke" / "schema.json")
    parser.add_argument("--summary-out", type=Path, default=PROJECT_ROOT / "artifacts" / "dev_smoke" / "collect_summary.json")
    ...
    parser.add_argument("--sample-prefix", default="dev_smoke")
